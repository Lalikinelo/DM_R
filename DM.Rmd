...
tm_shape(departement)+
  ...
  tm_text("nom_dep", size = 1, col="white")+
  tm_legend(show = FALSE)+
tm_shape(points)+
  # une carte par décénie
  tm_facets(by="decenieCreationEtablissement")+
  tm_dots(col="red") + 
  tm_layout(main.title="Ouverture de boulangeries par décénie", main.title.size = 1.2 , main.title.position = "center", bg.color = "lightgrey", inner.margins = c(.05, .02, .02, .02))+
...
tm_shape(final)+
  tm_polygons(col="n_commerce",style = "log10_pretty", title="Nombre de commerces") +
  tm_layout(legend.outside = TRUE, main.title="Commerces dans les departements 01,38,42,43,69", main.title.size=1.5,main.title.position="left", bg.color = "lightgrey", inner.margins = c(.05, .02, .02, .02))+
tm_shape(departement)+
